    ...
    <div class="gallery-area section-padding30 ">
        <div class="container-fluid ">
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img big-img" style="background-image: url(Weight\ 1.jpg);"></div>
                        <div class="overlay">
                            <div class="overlay-content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img big-img" style="background-image: url(Knee_Lunges.jpg);"></div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <h3>Dynamic Stretching</h3>
                                <a href="gallery.php"><i class="ti-plus"></i></a>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img big-img" style="background-image: url(Toe_Stretches.jpg);"></div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <h3>Dynamic Stretching </h3>
                                <a href="gallery.php"><i class="ti-plus"></i></a>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img big-img" style="background-image: url(Cardio_1.jpg);"></div>
                        <div class="overlay">
                            <div class="overlay-content">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                    <div class="box snake mb-30">
                        <div class="gallery-img big-img" style="background-image: url(Healthy_eating.jpg);"></div>
                        <div class="overlay">
                            <div class="overlay-content">
                                <h3>Dynamic Stretching </h3>
                                <a href="gallery.php"><i class="ti-plus"></i></a>
